        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/laljhal/1.webp"
                        alt="Laljhal"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        <p ref={addToParagraphRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            To strengthen the brand's digital presence, we created a modular social media system that ensures consistency and clarity.
                        </p>
                        ...
                        >
                            <li>Unified colour and typography framework</li>
                            <li>Template-driven layouts for scalability</li>
                            <li>High-impact visuals optimised for engagement</li>
                        </ul>
                    </div>
                </div>
            </div>
