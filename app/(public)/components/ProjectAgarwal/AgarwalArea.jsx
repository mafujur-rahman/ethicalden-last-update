            ...
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    <div>
                        ...
                        >
                            “Agarwal Tibrewal & Co. is a Chartered Accountancy firm offering financial, audit, and compliance services. Ethical Den collaborated with the firm to build a sharp, credible, and modern brand identity along with a clean, user-centric website experience.
                        </p>

                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            Our approach emphasised trust, clarity, and professionalism, qualities essential to the financial services ecosystem.
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            We designed a contemporary and authoritative logo built around the “CA” monogram, integrating clean lines and a dynamic tricolour element to reflect integrity, progress, and Indian financial expertise.
                        </p>
                         <p
                            ref={addToRefs}
                            className='text-2xl mb-3 font-bold lg:pr-12'
                        >
                            UI/UX-led decisions included:
                        </p>
                        ...
                        >
                            <li>Strong geometric balance for a trustworthy visual presence</li>
                            <li>Professional colour palette aligned with financial credibility</li>
                            <li>High scalability for digital and print applications</li>
                            <li>Typography that enhances readability across screens and stationery</li>
                        </ul>
                    </div>
