            ...
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    <div>
                        ...
                        >
                            “Emopract is an elder-care organisation dedicated to emotional wellbeing, personalised care, and holistic support for seniors. Ethical Den collaborated with emopract to build a soothing, empathetic brand identity along with a user-friendly website and a structured digital communication system.
                        </p>

                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            Our goal was to translate care, comfort, and reliability into a consistent visual and digital experience.
                        </p>
                       <h2 ref={addToRefs} className='text-3xl lg:4xl font-extrabold mb-5 text-black'>
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            The emopract logo is crafted to represent calmness, compassion, and emotional balance.
                        </p>
                         <p
                            ref={addToRefs}
                            className='text-2xl mb-3 font-bold lg:pr-12'
                        >
                             UI/UX-driven choices include:
                        </p>
                        ...
                        >
                            <li>Soft, nature-inspired green palette symbolising healing and reassurance</li>
                            <li>Rounded visual elements to evoke softness and trust</li>
                            <li>Minimal typography for screen-friendly readability</li>
                            <li>A smile-inspired icon form to highlight emotional well-being</li>
                        </ul>
                    </div>
