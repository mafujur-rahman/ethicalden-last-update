        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/emopract/3.webp"
                        alt="Emopract"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800 lg:pr-12'>
                            The result is a digital experience that feels safe, warm, and human-centred.
                        </p>
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            We built a social media identity that communicates empathy, clarity, and credibility.
                        </p>
                         <p
                            ref={addToRefs}
                            className='text-2xl mb-3 font-bold lg:pr-12'
                        >
                            Core UI/UX principles integrated into the design system:
                        </p>
                        ...
                        >
                            <li>Consistent visual language with soft tones and approachable layouts</li>
                            <li>Modular grid structures for organised storytelling</li>
                            <li>Readable typography for seniors and caregivers</li>
                            <li>Optimised information architecture to guide users quickly to relevant sections</li>
                            <li>Emotion-focused content style, highlighting care, connection, and community</li>
                        </ul>
