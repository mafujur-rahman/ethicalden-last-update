...
const EmopractFooter = () => {
    ...
    return (
        ...
        >
            ...
            {/* Background Image */}
            <Image
                src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/emopract/footer.webp"
            ...
            <div className="absolute top-0 left-0 right-0 z-10 pt-10 md:pt-16 lg:mt-10 xl:mt-16 2xl:mt-20 px-5 md:px-10 lg:px-16 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto text-center">
                ...
                <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-[#09e5e5] to-[#a8ff57] text-4xl md:text-6xl font-bold leading-[1.15] pb-1">Sandeep Autolines</h1>
