        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/mak-community/1.webp"
                        alt="Mak Community"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        >
                            The identity communicates kindness, protection, and enrichment, core to Mak Community’s mission
                        </p>
                        ...
                        <p ref={addToParagraphRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                           A structured, grid-based layout designed for readability and trust.
                        </p>
                        ...
                        >
                            ...
                            <li>Spacious layouts for stress-free scanning</li>
                            <li>Colour usage aligned with brand emotion</li>
                        </ul>
                         <h2 ref={addToParagraphRefs}
                        ...
                        <p
                            ...
                            className='text-xl lg:text-2xl mb-8 text-gray-800 lg:pr-12'
                        >
                            Minimal and professional, designed to reinforce organisational reliability and consistency.
                        </p>
                    </div>
                </div>
            </div>
