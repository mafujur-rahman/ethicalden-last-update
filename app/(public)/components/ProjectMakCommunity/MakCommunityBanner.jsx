        ...
        <div>
            ...
            <div className='mt-10 lg:mt-20 lg:flex lg:justify-between'>
                <div className='flex-1 lg:flex-2/3'>
                    ...
                    >
                        {"Mak Community: Designing a Compassion-First Identity for an Enrichment & Caregiving Organisation".split(" ").map((word, wi) => (
                            <span
                                key={wi}
                ...
                <div className='flex flex-1 lg:flex-1/3 mt-10 lg:mt-0 lg:justify-end justify-between lg:gap-20 xl:gap-30'>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li className='text-xl font-bold mb-1'>Caregiving Services</li>
                    </ul>
                </div>
            </div>
        </div>
