            ...
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    <div>
                        ...
                        >
                            “Marzii is a youth-driven men’s clothing brand that celebrates individuality and personal choice. Ethical Den partnered with Marzii to build a cohesive visual ecosystem, from brand identity to packaging to social media, designed with consistency, clarity, and user-focused aesthetics.
                        </p>
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            We crafted a bold, expression-oriented logo supported by a clean typography system.
                        </p>
                         <p
                            ref={addToRefs}
                            className='text-2xl mb-3 font-bold lg:pr-12'
                        >
                            UI-driven principles ensured:
                        </p>
