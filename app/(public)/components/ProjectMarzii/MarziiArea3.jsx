        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/marzii/details-img-2.webp"
                        alt="Marzii"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        >
                            Designed to remain premium, functional, and instantly recognisable.
                        </p>
                        ...
                        >
                            <li>A clean information layout with purposeful whitespace and precise alignment.</li>
                            <li>Optimised for clarity, touchpoints, and easy brand recall.</li>
                        </ul>
                    </div>
                </div>
            </div>
