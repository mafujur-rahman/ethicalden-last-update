            ...
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    <div>
                        ...
                        >
                            “massArt is an organisation dedicated to preserving, showcasing, and promoting the rich artistry behind Kolkata’s iconic Durga Puja pandals. Ethical Den partnered with MassArt to build a dynamic digital presence that captures the scale, craft, and cultural impact of this world-renowned festival.
                        </p>

                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            Our focus was to create an immersive, information-rich platform paired with a structured social media system — enabling massArt to reach global audiences while honouring local artisans.
                        </p>
