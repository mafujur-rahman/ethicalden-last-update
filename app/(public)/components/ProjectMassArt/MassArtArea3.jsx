        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/massArt/2.webp"
                        alt="“massArt"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        >
                            ...
                            <li>Highlight artisan work</li>
                            <li>Provide authoritative information on Durga Puja art</li>
                            <li>Create a global-facing digital archive for Kolkata’s cultural heritage</li>
                        </ul>
                    </div>
                </div>
            </div>
