            ...
            <div className='flex flex-col lg:flex-row justify-between gap-10'>
                ...
                <div className='lg:w-3/4 flex gap-5'>
                    <div>
                        ...
                        >
                            “Mr Cafe partnered with Ethical Den to build a cohesive brand identity and a seamless digital ecosystem that reflects its warm, modern cafe experience. Our goal was to design a visual and functional language that feels intuitive, inviting, and aligned with the cafe’s personality.
                        </p>
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            We crafted a unified brand system that translates the essence of Mr Cafe into every touchpoint.
                        </p>
                        {/* <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
