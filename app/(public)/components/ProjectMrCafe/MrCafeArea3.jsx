        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/mr-cafe/details-img-2.webp"
                        alt="Mr Cafe"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        >
                            <li>Developed warm, welcoming invitation cards for events and special launches</li>
                            <li>Balanced typography and imagery for a premium cafe aesthetic</li>
                            <li>Ensured print-ready designs with high visual clarity</li>
                        </ul>
                        {/* <p
                            ref={addToRefs}
