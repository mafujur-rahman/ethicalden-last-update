        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/mr-cafe/details-img-3.webp"
                        alt="Mr Cafe"
                        width={1270}
                        height={630}
                        placeholder='blur'
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        >
                            <li>Created sleek, balanced cards reflecting the brand’s modern tone</li>
                            <li>Used a functional grid system for a clear information hierarchy</li>
                            <li>Integrated the brand palette to maintain identity consistency</li>
                        </ul>
