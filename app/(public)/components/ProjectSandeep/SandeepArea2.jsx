        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/sandeep-autolines/1.webp"
                    ...
                    <div className='lg:w-3/4 mt-10'>
                       <h2 ref={addToParagraphRefs} className='text-3xl lg:4xl font-extrabold mb-5 text-black'>
                        ...
                        <p ref={addToParagraphRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            A minimal and refined layout built around clarity and professionalism.
                        </p>
                        ...
                        >
                            <li>Clean typographic hierarchy</li>
                            <li>Adequate whitespace for a premium feel</li>
                            <li>Brand colours are applied subtly for elegance</li>
                        </ul>
                    </div>
                </div>
            </div>
