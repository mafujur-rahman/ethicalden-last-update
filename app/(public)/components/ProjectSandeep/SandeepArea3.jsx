        ...
        <div className=' mb-10 px-5 md:px-10 xl:px-20 2xl:max-w-screen-2xl 2xl:mx-auto'>
            <div className=''>
                <div className='lg:mr-10 relative'>
                    ...
                    <Image
                        ref={imageRef}
                        src="https://pub-d88e94f6ca8d4f2d9dcb7f5ba3ccfcf0.r2.dev/work-details/sandeep-autolines/2.webp"
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-10'>
                    ...
                    <div className='lg:w-3/4 mt-10'>
                        ...
                        <p ref={addToRefs} className='text-xl lg:text-2xl mb-8 text-gray-800'>
                            Crafted with a modern, high-contrast layout to reflect the brand’s bold visual personality.
                        </p>
                        ...
                        >
                            <li>Strong identity placement</li>
                            <li>Balanced spacing</li>
                            <li>Easy-to-scan information structure</li>
                            <li>Designed to create a sharp first impression.</li>
                        </ul>
