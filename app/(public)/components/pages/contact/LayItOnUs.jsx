                ...
                <div className="space-y-8 flex-2/3 relative">
                    ...
                    <div className="relative font-helvetica">
                        <label
                            ...
                            className={`absolute left-6 ${projectAboutRef.current?.value ? 'top-2 text-sm' : 'top-3 text-xl'} py-3 pr-4 pointer-events-none text-gray-300 font-bold font-helvetica transition-all`}
                        >
