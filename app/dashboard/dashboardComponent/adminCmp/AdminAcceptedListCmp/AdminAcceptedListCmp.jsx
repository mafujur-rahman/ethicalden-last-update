...
export default function AdminAcceptedListCmp () {
    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          'https://api.clientservice.mrshakil.com/api/client_service_questionaries/?service_status=Accepted',
          {
            headers: {
